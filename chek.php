                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#home" role="tab">All </a></li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#today" role="tab">Today </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Yesterdays" role="tab">Yesterday </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Tomorrows" role="tab">Tomorrow </a></li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#active" role="tab">Active </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#pending" role="tab">Pending </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#com" role="tab">Complete </a> </li>
                            </ul>
                        <div class="tab-content">
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and user='$id' ORDER BY id DESC");
                             ...
                             <div class="table-responsive m-t-40" >
                                    <table id="z1" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
                                ...
                                <div class="tab-pane" id="Yesterdays" role="tabpanel">  
                            <div class="table-responsive m-t-40" >
                                    <table id="z2" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and date ='$pr' and user='$id' ORDER BY id DESC");
                              ...
                              <div class="tab-pane" id="Tomorrows" role="tabpanel">  
                               <div class="table-responsive m-t-40">
                                    <table id="z3" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and date ='$pr1' and user='$id' ORDER BY id DESC");
                             ...
                             <div class="table-responsive m-t-40" >
                                    <table id="z4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$today=date("Y-m-d");
														$pr1=date('Y-m-d',strtotime("+1 days"));
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and status ='1' and user='$id' ORDER BY id DESC");
                           ...
                           <div class="table-responsive m-t-40" >
                                    <table id="z5" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$today=date("Y-m-d");
														$pr1=date('Y-m-d',strtotime("+1 days"));
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and status ='2' and user='$id' ORDER BY id DESC");
                             ...
                             <div class="tab-pane" id="com" role="tabpanel">  
                            <div class="table-responsive m-t-40" >
                                    <table id="z6" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th>Sr no</th>
												<th>Employee Names</th>
										...
										<tbody>
											<?php
												  $c_name = 	$_SESSION['c_id'];
														...
														$today=date("Y-m-d");
														$pr1=date('Y-m-d',strtotime("+1 days"));
														$result=mysqli_query($con,"select * from task where c_name='$c_name' and status ='3' and user='$id' ORDER BY id DESC");
