...
session_start();
$id=$_GET['id'];
$selectcka=mysqli_query($con,"SELECT * FROM `cash_voucher2` WHERE id='$id'");
...
$sid = $_SESSION['id'];
$selectckad=mysqli_query($con,"SELECT * FROM `cash_voucher2` WHERE id='$sid'");
$rowckad=mysqli_fetch_array($selectckad);

$cid=$_GET['cid'];
$selectckab=mysqli_query($con,"SELECT * FROM `cash_voucher2` WHERE id='$cid'");
$rowckab=mysqli_fetch_array($selectckab);

$selectckas=mysqli_query($con,"SELECT * FROM `cash_voucher2`");
$rowckas=mysqli_fetch_array($selectckas);
$sid = $rowcka['login'];

$selectckas1=mysqli_query($con,"SELECT * FROM `tem_emp2` where id='$uid'");
                ...
                <div class="main">
                    ...
                    <div class="receipt">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                            <h3 class="heading_rec">Date: <?php echo $rowcka['select_date']; ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="logo_l2">
                                         ...
                                         <div style=" border-bottom: 1px dotted black; padding-bottom: 5px;">
										         <strong>Name: </strong>  <?php echo $rowcka['sname']; ?>
										        </div></h5>  
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="hh1">
                                        <div class="col-md-8">
                                            <div class="logo_l5">
                                                 ...
                                                 <p><strong><?php echo $rowcka['d_name']; ?></strong>  
...
"><strong>Rupees:</strong> <?php echo convertNumberToWord($rowcka['amount']); ?></h5><br>
                    ...
                    <div class="row">
                        <div class="hh5">
                                ...
                                <div class="col-md-3">
                                    <div class="logo_22">
                                        <p style="margin-bottom: 20px;"><?php echo $rowcka['pname']; ?></p>
