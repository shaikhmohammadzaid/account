...
?>
	<body>
		...
		<article>
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center">OutStanding Cheque </h3>
					<table class="inventory">
						...
						<tbody>
									...
									<?php
								 	...
								 	$resulty7=mysqli_query($con,"select * from cash_voucher2 WHERE cheque_status ='0' AND dte = '$tdate' AND ptype = 'cheque' AND c_name = '$c_id'   " );
					...
					<?php echo $mk; ?> 
					 ...
					 <?php echo $mkqe; ?> 
						...
						<span data-prefix></span><span style="word-break: break-all;"></span><?php
									 ...
									 $sql111 =mysqli_query($con,"SELECT SUM(amount) AS value_sum FROM cash_voucher2 WHERE cheque_status ='0' AND dte = '$tdate' AND ptype = 'cheque' AND c_name = '$c_id' ");  
