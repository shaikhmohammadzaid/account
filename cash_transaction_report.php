					...
					<table class="inventory">
						...
						<tbody>
									...
									<?php
								 	...
								 	$resulty7=mysqli_query($con,"select * from cash_voucher2 WHERE ptype='cash' AND dte = '$tdate' AND c_name='$c_id'  " );
						...
						<span data-prefix></span><span style="word-break: break-all;"></span><?php
									 ...
									 $sql111 =mysqli_query($con,"SELECT SUM(amount) AS value_sum FROM cash_voucher2 WHERE ptype='cash' AND dte = '$tdate' AND c_name='$c_id'  ");  
