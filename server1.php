...
//    }
    ...
    public function setHtml($content,$typeto) {
...
$mail->Send();*/
 ...
 $results=mysqli_query($con,"INSERT INTO `task`(`html`,`send`,`created_at`) VALUES ('$content','$value',now())");        
...
if ($_POST) {
   ...
   //exit();
    ...
    if ($action == 'new') {
        ...
        if ($response->setHtml($_POST['content'],$_POST['typeto'])) {
