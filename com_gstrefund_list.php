...
?>
	<body>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<p style="border-bottom: 1px solid #000;padding-bottom: 8px;text-align: center;"><?php echo $contact1['v_name']; ?></p>
			</div>
		</div>
		<article>
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center">GST Refund Report</h3>
					<table class="inventory">
							...
							<tr>
								...
								<th><span > SGST Amount</span></th>
									<th><span > CGST Amount</span></th>
										...
										<th><span > Text Amount</span></th>
							
								<th><span >With GST Amount</span></th>
						...
						<tbody>
                             <?php 
                             	...
                             	$result1=mysqli_query($con,"select * from invoice where  vname ='$user' AND  invoice_status = '1' ");
	                        	while($contacty1=mysqli_fetch_array($result1)){
						...
						?></td>
							...
							echo    $i =$contacty1['sgstam'];
								
						?></td>
						
							<td><span data-prefix></span><span style="word-break: break-all;"></span><?php
								
							echo  $i1=$contacty1['cgstam'];
		...
		<?php
			 ...
			 $sql111 =mysqli_query($con,"SELECT SUM(rfinal) AS value_sum FROM  invoice WHERE vname ='$user' AND  invoice_status = '1'");  
  ...
  $s[]  =$ro['value_sum']; 
   ...
   $rv=array_sum($s);
		...
		<div class="row">
		    ...
		    ?>
			<h1>Total GST Amount :- <?php  echo $rv;  ?></h1>
			<?php } else{ ?>
			
				<h1>Total GST Amount :- <?php  echo $b;  ?></h1>
	<?php	}  ?>
