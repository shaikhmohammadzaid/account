                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
									<form name="form" action="tem_assign_vn.php" method="POST" onsubmit="return deleteConfirm();"/>
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										<?php
										$pid=$_GET['pid'];
											$result1=mysqli_query($con,"select * from tem_emp2 WHERE status='0'");
										...
										<option  value="">Temporary Employee</option>
										<?php
											$result1=mysqli_query($con,"select * from tem_emp2");
											while($contact1=mysqli_fetch_array($result1))
											{
										?>	
										<option  value="<?php echo $contact1['id'] ?>"><?php echo $contact1['v_name']  ?></option>
