									  ...
									  <div class="form-group">
										...
										<div class="col-md-6" style="display:none;" id="i31">
											<div class="form-group">
												...
												<select name="invoice" id="i21" class="form-control" data-rel="chosen" >
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text"  class="form-control c_amount"  placeholder="Enter Amount" name="c_amount" required data-validation-required-message="This field is required">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="cat"  class="select2 form-control custom-select" data-rel="chosen" >
