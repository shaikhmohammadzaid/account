										...
										<tbody>
											<?php
													...
													if($id)
													{
														...
														$result=mysqli_query($con,"select * from bank WHERE bank_name LIKE '%$bank_name%' ORDER BY id DESC");
													}
													else
													{
													    $c_name = $_SESSION['id'];
														$result=mysqli_query($con,"select * from bank ORDER BY id DESC");
													}
											...
											<tr>
												...
												<td class="center"><?php $rt= $contact['c_name'];
												
													$result22=mysqli_query($con,"select * from company where c_id='$rt' ORDER BY id DESC");
													$contact11=mysqli_fetch_array($result22);
													echo $contact11['username'];
