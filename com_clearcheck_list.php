...
?>
	<body>
		...
		<article>
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center">Clear Cheque </h3>
					<table class="inventory">
						<thead>
							<tr>
							    <th><span >Cheque Clear Date</span></th>
						...
						<tbody>
									...
									<?php
								 	...
								 	$resulty7=mysqli_query($con,"select * from cash_voucher2 WHERE cheque_status ='3' AND final_clear_date = '$tdate' AND ptype = 'cheque' AND c_name='$c_id'  " );
					...
					<?php echo $mk; ?> 
					 ...
					 <?php echo $mkqe; ?> 
						...
						<span data-prefix></span><span style="word-break: break-all;"></span><?php
									 ...
									 $sql111 =mysqli_query($con,"SELECT SUM(amount) AS value_sum FROM cash_voucher2 WHERE cheque_status ='3' AND final_clear_date = '$tdate' AND ptype = 'cheque' AND c_name='$c_id'  ");  
