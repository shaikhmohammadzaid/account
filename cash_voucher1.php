                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40"  method="post" enctype="multipart/form-data">
									...
									<select name ="cname" class="form-control" data-rel="chosen" id="rv"  >
									...
									<div class="col-md-6" >
									  ...
									  <div class="form-group">
										...
										<div class="col-md-6">
											...
											<input type="text"  class="form-control " placeholder="Enter Name" name="sname" required data-validation-required-message="This field is required">
									...
									<div class="col-md-6"   >
										    ...
										    <div class="form-group">
												...
												<select name="sub" id="vname" class="form-control" data-rel="chosen" >
										...
										<div class="col-md-6" style="display:none;" id="cheque1">
												...
												<h5 class="m-t-30" style="margin-top:0px;">Select Cheque</h5>
									  ...
									  <div class="form-group">
										<label class="control-label">Description</label>
										  <textarea rows="4" cols="50" class="form-control" placeholder="Description" name="d_name" required ></textarea>
										    </div>
									        	</div>
...
$(document).ready(function(){
    $('#rv').on('change',function(){
        ...
        if(perID){
            ...
            $('#country').html('<option value="">Select bank</option>');
