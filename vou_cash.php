...
<html>
	<head>
		<meta charset="utf-8">
		<title>Cash Voucher Recipt | Namasteji Account Manager</title>
		<style>
		/* reset */
<?php
...
session_start();
$id=$_GET['id'];
$selectcka=mysqli_query($con,"SELECT * FROM `cash_voucher` WHERE id='$id'");
$rowcka=mysqli_fetch_array($selectcka);

$dc = $rowcka['id'];
$uid = $rowcka['pname'];
$cate = $rowcka['category'];

$selectcka3=mysqli_query($con,"SELECT * FROM `sub_ct` WHERE id='$cate'");
$rowcka3=mysqli_fetch_array($selectcka3);
$sid3 = $rowcka3['sub_nm'];

$sid = $_SESSION['id'];
$selectckad=mysqli_query($con,"SELECT * FROM `cash_voucher` WHERE id='$sid'");
$rowckad=mysqli_fetch_array($selectckad);

$cid=$_GET['cid'];
$selectckab=mysqli_query($con,"SELECT * FROM `cash_voucher` WHERE id='$cid'");
$rowckab=mysqli_fetch_array($selectckab);

$selectckas=mysqli_query($con,"SELECT * FROM `cash_voucher`");
$rowckas=mysqli_fetch_array($selectckas);
$sid = $rowcka['login'];

$selectckas1=mysqli_query($con,"SELECT * FROM `vendor_registration` where id='$uid'");
$rowckas1=mysqli_fetch_array($selectckas1);
$sid1 = $rowckas1['v_name'];
				...
				<div class="main">
					...
					<div class="receipt">
						...
						<div class="col-md-4">
							...
							<div class="col-md-4">
							<h3 class="heading_rec">BANK RECEIPT VOUCHER</h3>
							</div>
							<div class="col-md-4">
						 ...
						 <div class="hh">
								<div class="col-md-8">
									<div class="logo_l2">
										 ...
										 <h5 class="pay_heading">
										 <div style=" border-bottom: 1px dotted black; padding-bottom: 5px;">
										         <strong>Name: </strong>  <?php echo $sid1; ?> 
										        </div></h5>
									</div>
								</div>
								<div class="col-md-4">
					...
					<div class="row">
							<div class="hh1">
										<div class="col-md-8">
											...
											<center style="padding-top:5px">	<h2 class="pay_heading1"> Being amount Paid for <strong><?php echo $sid3; ?></strong> 
											     To  <strong> <?php echo $sid1; ?> </strong> 
												   Amount RS 	 <strong><?php echo $rowcka['amount']; ?></strong>
			                                       On date <strong><?php echo $rowcka['issu_date']; ?></strong>
			                                       cheque no:<?php echo $rowcka['check_no'] ?></h2> </center>
						...
						<div class="hh5">
								<div class="col-md-3">
									<div class="logo_22">
										 ...
										 <h5 class="pay_heading3">Verified By</h5><br>
...
"></p>
								...
								<div class="col-md-3">
									<div class="logo_22">
										<p style="margin-bottom: 20px;"><?php echo $sid1; ?></p>
						...
						<img  src="cashvou/<?php echo $rowcka['profile'] ?>" width="700" height="300" / style="margin-top:40px;">
						      						        </div>
